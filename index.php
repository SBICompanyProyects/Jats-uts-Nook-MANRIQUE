...
$MisFavoritos = "SELECT * FROM productos limit 6";
?>
    <!DOCTYPE html>
    <html lang="es">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse DIV__BTNsINDEX" id="navbarScroll">
                    ...
                    <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                        <li class="nav-item">
                            <a class="nav-link btn btn-outline-success NavBarIndex__GrupBTNs" aria-current="page" href="ProducVisita.php">PRODUCTOS</a>
                        </li>
                        <li class="nav-item">
...
mysqli_free_result($ResFav);?>
        ...
        <script src="JS/LibJSExtras/lightbox.js"></script>
    </body>
